...
proj=qwen2.5-vl-3b_gui_rise_mind2web
exps=aitw_true
...
train_data=../../../DATASET/Min2Web/metadata/full_data.parquet
test_data=../../../DATASET/Min2Web/metadata/subset_data.parquet
base_model_path=
save_model_path=./checkpoints/${proj}/${exps}
reward_function_path=../../verl/utils/reward_score/mind2web.py
