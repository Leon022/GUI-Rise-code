...
class RewardFunction:
    def __init__(self, module, reward_kwargs, function_name):
        # self.module = module
        self.reward_kwargs = reward_kwargs
        self.function_name = function_name
        self.raw_fn = getattr(module, self.function_name)
...
def get_custom_reward_fn(config):
    ...
    return RewardFunction(module, reward_kwargs, function_name)
