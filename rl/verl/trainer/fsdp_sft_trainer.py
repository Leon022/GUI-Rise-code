...
from transformers import AutoConfig, AutoModelForCausalLM, PreTrainedModel, AutoModelForVision2Seq, Qwen2VLForConditionalGeneration
...
class FSDPSFTTrainer:
    ...
    def _build_model_optimizer(self):
        ...
        with init_context():
            # self.model: PreTrainedModel = Qwen2VLForConditionalGeneration.from_pretrained(
            #     local_model_path,
            #     config=config,
